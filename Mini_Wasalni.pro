...
SOURCES += \
    ...
    delete_city.cpp\
    deletecity_error.cpp\
    deletecity_successfully.cpp\
    deleteroad.cpp\
    dfs.cpp\
    displaymapdata.cpp\
    enumerators.cpp\
